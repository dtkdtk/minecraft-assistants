...
- [ ] launcher: Авто-установка версии игры, если та не найдена (отлов исключения из `/src/launcher/_mcdata-provider.cjs`)
...
- [ ] launcher (build): Добавить предустановленные версии (minify JSON, сжатие в zip/zstd/tar-xz/etc.)
